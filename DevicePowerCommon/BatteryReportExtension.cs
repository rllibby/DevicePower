...
namespace DevicePowerCommon
{
    ...
    public static class BatteryReportExtension
    {
        ...
        public static int Percentage(this BatteryReport report)
        {
            if (((report.RemainingCapacityInMilliwattHours == null) || (report.FullChargeCapacityInMilliwattHours == null))) return 0;
        ...
        public static string StatusDescription(this BatteryReport report)
        {
